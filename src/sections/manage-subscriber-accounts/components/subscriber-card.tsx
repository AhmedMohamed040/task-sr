...
export default function SubscriberCard({ user }: Props) {
  ...
  const { id, name, type, coverUrl, role, numberOfBranches, address, avatarUrl, workingHours } =
    user;

  return (
    <Card sx={{ textAlign: 'center' }}>
      <Link
        className="hovering-pan"
        style={{ textDecoration: 'none', color: 'inherit' }}
        href={`${paths.dashboard.ManageSubscriberAccounts}/${id}`}
      >
